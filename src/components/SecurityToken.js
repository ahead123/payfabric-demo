    ...
    <>
      <Row>
        <Col className="text-center">
          ...
          <p>
            The required credentials <code>Device ID</code>, and{' '}
            <code>Device Password</code> are provided by PayFabric via
            the web portal on the Device Management page.
          </p>
          <p>
            After successfully authenticating with the PayFabric API,
            you will receive a security token that you can use to make
            requests to the API.
          </p>
          <p>
          ...
          <p>
            ...
            <code>
              https://github.com/PayFabric/Hosted-Pages/blob/master/Sections/Security%20Token.md
            </code>
            <br />
          </p>
          <p>
      ...
      <Row className="mt-5 mb-5">
        ...
        <Col className="text-center">
          <Link to="/transaction/create">Next</Link>
        </Col>
      </Row>
    </>
  );
